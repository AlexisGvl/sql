...
SELECT *
FROM student
WHERE email LIKE "%.fr%" OR created_at <= '2021-01-10 00:00:00'
...
SELECT *
FROM student
WHERE created_at >= '2021-01-01 00:00:00' AND created_at <= '2021-01-10 00:00:00'
...
SELECT *
FROM project
WHERE description NOT LIKE "%Dolores%" AND start_date >= '2021-07-01 00:00:00';
...
SELECT *
FROM student 
WHERE email LIKE '%.fr%' AND created_at <= '2021-01-10 00:00:00' OR project_id IS NOT NULL
...
SELECT *
FROM student 
WHERE email LIKE '%.fr%' AND created_at <= '2021-01-10 00:00:00' AND project_id IS NULL
